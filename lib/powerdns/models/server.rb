...
module PowerDNS
  class Server
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'daemon_type')
        self.daemon_type = attributes[:'daemon_type']
      end
      ...
      if attributes.has_key?(:'config_url')
        self.config_url = attributes[:'config_url']
      end

      if attributes.has_key?(:'zones_url')
        self.zones_url = attributes[:'zones_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          id == o.id &&
          daemon_type == o.daemon_type &&
          version == o.version &&
          url == o.url &&
          config_url == o.config_url &&
          zones_url == o.zones_url
    end
    ...
    def hash
      [type, id, daemon_type, version, url, config_url, zones_url].hash
    end
