...
module PowerDNS
  ...
  class Comment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'modifided_at')
        self.modifided_at = attributes[:'modifided_at']
      end
    ...
    def hash
      [content, account, modifided_at].hash
    end
